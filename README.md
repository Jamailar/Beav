...
RedBox 2.4.0 正式版把浏览器能力从“读网页内容”升级到“操作你正在使用的真实 Chrome”。AI 可以在你授权后接管已打开的后台、数据面板或网页工具，读取页面内容、点击筛选、输入搜索、滚动和截图，用来完成需要登录态和真实页面交互的任务。这一版也补上了 Task Brief、工具层瘦身和对话过程显示优化，长任务不再只靠聊天记录硬撑。
