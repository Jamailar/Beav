...
### v2.0.0 (2026-05-14)
- 新增声音复刻与角色克隆，让固定账号、虚拟角色和系列化内容可以保持更稳定的人设与声线一致性
- 视频生成模型接入 Seedance 2.0，提升画面质感、运动连贯性和短视频生成稳定性
- 支持视频分析与剪辑，可拆解爆款视频结构、识别高光片段，并剪辑精彩切片
- 升级全新 UI 体验，收敛入口层级，减少视觉噪音，让素材、生成、任务和结果管理更直观
- 强化 Agent 系统稳定性，优化任务规划、工具调用、上下文传递与结果汇总，对标自媒体版 Codex 的连续创作工作流
