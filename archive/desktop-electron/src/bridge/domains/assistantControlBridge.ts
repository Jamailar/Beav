...
export function createAssistantControlBridge(core: BridgeCore) {
  return {
    assistantDaemon: {
      ...
      createAcpClient: (payload?: Record<string, unknown>) =>
        core.invokeChannel('assistant:daemon-acp-client-create', payload || {}),
      revokeAcpClient: (payload?: Record<string, unknown>) =>
        core.invokeChannel('assistant:daemon-acp-client-revoke', payload || {}),
      startWeixinLogin: (payload?: Record<string, unknown>) =>
        core.invokeChannel('assistant:daemon-weixin-login-start', payload || {}),
      waitForWeixinLogin: (payload?: Record<string, unknown>) =>
        core.invokeChannel('assistant:daemon-weixin-login-wait', payload || {}),
