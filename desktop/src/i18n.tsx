...
const zhCN = {
  ...
  'layout.opening': '打开中...',
  'layout.later': '稍后',
  'layout.openRelease': '打开 Release',
  'layout.manualInstall': '手动安装',
  'layout.electronManualInstallHint': 'Electron 开源版会打开 GitHub Release，下载对应系统安装包后手动安装。',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'layout.later': 'Later',
  'layout.openRelease': 'Open Release',
  'layout.manualInstall': 'Manual install',
  'layout.electronManualInstallHint': 'The open-source Electron build opens the GitHub Release. Download the installer for your system and install it manually.',
