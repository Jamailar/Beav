...
const zhCN = {
  ...
  'settings.general.updateDescription': '启动时自动检查新版本，安装包从 RedBox 下载源获取。',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'settings.general.updateDescription': 'RedBox checks for updates on launch. Installers are downloaded from RedBox release sources.',
