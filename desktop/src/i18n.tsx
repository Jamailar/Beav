...
const zhCN = {
  ...
  'app.clipboardCaptureDetected': '检测到{label}链接',
  'app.clipboardCaptureDescription': '确认后将创建后台采集任务并保存到知识库。',
  'app.clipboardCaptureIncludeComments': '包含评论',
  ...
  'layout.initializingSpaceName': '待初始化空间',
  ...
  'layout.founderSponsor.pointsValue': '价值约 ¥220+',
  ...
  'layout.founderSponsor.rechargeButton': '充值',
  'layout.founderSponsor.inviteTitle': '邀请好友，双方获得200积分',
  'layout.founderSponsor.inviteDesc': '复制邀请码发给好友，注册后双方获得积分奖励。',
  'layout.founderSponsor.inviteCodePending': '待同步',
  'layout.founderSponsor.inviteCopyButton': '复制邀请码',
  'layout.founderSponsor.inviteCopied': '邀请码已复制',
  'layout.founderSponsor.inviteCopyFailed': '复制失败，请手动选择邀请码',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'app.clipboardCaptureDetected': '{label} link detected',
  'app.clipboardCaptureDescription': 'Confirm to create a background capture task and save it to Knowledge.',
  'app.clipboardCaptureIncludeComments': 'Include comments',
  ...
  'layout.initializingSpaceName': 'Initializing space',
  ...
  'layout.founderSponsor.pointsValue': 'Approx. value ¥220+',
  ...
  'layout.founderSponsor.rechargeButton': 'Recharge',
  'layout.founderSponsor.inviteTitle': 'Invite friends, both get 200 points',
  'layout.founderSponsor.inviteDesc': 'Copy your invite code. Both accounts receive points after signup.',
  'layout.founderSponsor.inviteCodePending': 'Sync pending',
  'layout.founderSponsor.inviteCopyButton': 'Copy code',
  'layout.founderSponsor.inviteCopied': 'Invite code copied',
  'layout.founderSponsor.inviteCopyFailed': 'Copy failed. Select the code manually.',
