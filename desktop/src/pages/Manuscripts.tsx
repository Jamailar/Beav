...
export function Manuscripts({ pendingFile, onFileConsumed, onNavigateToRedClaw, onNavigateToGenerationStudio, isActive = false, editorOnly = false, onCloseEditor, onImmersiveModeChange }: ManuscriptsProps) {
    ...
    return (
        <>
        <div className="h-full min-h-0 overflow-auto text-text-primary">
                                ...
                                {contentCards.length === 0 ? (
                                    ...
                                    <div className={clsx(layout === 'gallery' ? 'grid grid-cols-[repeat(auto-fill,minmax(176px,1fr))] gap-x-4 gap-y-6' : 'space-y-2')}>
                                        {contentCards.map((card) => {
                                            if (card.kind === 'draft') {
                                                const typeStyle = resolveDraftTypeStyle(card.draftType);
                                                        ...
                                                        {layout === 'gallery' ? (
                                                            ...
                                                            >
                                                                <div className={clsx(
                                                                    ...
                                                                    <div className="absolute inset-0 p-4 flex flex-col">
                                                                        <div className={clsx('inline-flex h-8 w-8 items-center justify-center rounded-lg shadow-sm', typeStyle.iconWrap)}>
                                                            ...
                                                            >
                                                                <div className="flex min-w-0 items-center gap-4">
                                                                    <div className={clsx('flex h-9 w-9 items-center justify-center rounded-lg shadow-sm', typeStyle.tile)}>
