...
const slowOperationPattern = /(\bfs::|std::fs::|\.await\b|reqwest::|Command::new|spawn_blocking|tauri::async_runtime::spawn\s*\(|compute_embedding_with_settings\s*\(|run_official_\w+\s*\(|run_authenticated_official_\w+\s*\(|fetch_remote_official_\w+\s*\()/;
