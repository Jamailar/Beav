...
use crate::{
    ...
    fetch_ytdlp_channel_info, make_id, now_iso, parse_youtube_channel, parse_ytdlp_videos,
    payload_field, payload_string, read_text_file_or_empty, slug_from_relative_path,
    AdvisorVideoRecord, AppState, YoutubeVideoRecord,
};
...
fn upsert_failed_advisor_video(
    state: &State<'_, AppState>,
    advisor_id: &str,
    channel_id: &str,
...
fn persist_successful_download(
    state: &State<'_, AppState>,
    advisor_id: &str,
    channel_url: &str,
    channel_id: &str,
