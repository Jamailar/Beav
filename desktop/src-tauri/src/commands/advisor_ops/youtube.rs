...
#[path = "youtube_video_download.rs"]
mod youtube_video_download;
...
use crate::{
    ...
    payload_string, slug_from_relative_path, AdvisorVideoRecord, AppState,
};
...
use youtube_video_download::{download_video_value, retry_failed_value};
