...
use crate::cli_runtime::{
    approve_cli_escalation, build_cli_sandbox_spec, build_cli_tool_manifest,
    build_effective_environment, cancel_cli_execution, collect_cli_requested_permissions,
    create_task_ephemeral_environment, default_cli_execution_mode, deny_cli_escalation,
    detect_tool, detect_tool_with_shell_probe, discover_all_commands, emit_cli_escalation_resolved,
    emit_cli_execution_status, emit_cli_verification_finished, ensure_app_global_environment,
    ...
    list_cli_environments, list_cli_tool_records, load_cli_execution_snapshot,
    load_host_shell_snapshot, refresh_cli_execution, resolve_cli_environment, run_cli_verification,
    sandbox_metadata, upsert_cli_tool_manifest, upsert_cli_tool_record,
