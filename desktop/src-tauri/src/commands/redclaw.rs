...
#[path = "redclaw/project_updates.rs"]
mod redclaw_project_updates;
...
use crate::{ffmpeg_executable, now_iso, parse_json_value_from_text, payload_string, AppState};
...
use redclaw_project_updates::{update_redclaw_learning_candidate, update_redclaw_project_section};
