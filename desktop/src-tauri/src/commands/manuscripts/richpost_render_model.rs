...
#[path = "richpost_render_model/preview_shell.rs"]
mod preview_shell;
#[path = "richpost_render_model/style.rs"]
mod style;
#[path = "richpost_render_model/zones.rs"]
mod zones;

pub(super) use preview_shell::render_richpost_preview_shell;
pub(super) use style::{
    richpost_css_var_map_from_tokens, richpost_css_var_style_attr, richpost_token_value,
};
...
fn render_richpost_master_fragment(
    ...
    zones::render_richpost_master_fragment(master_fragment, page, blocks_by_id, assets_by_id)
}
