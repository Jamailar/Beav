    ...
    if runtime_mode == "wander" {
        ...
        sections.push(
            [
                ...
                "Keep the process lean: use redbox_fs(action=workspace.list|workspace.read|workspace.search) only when the preloaded material bundle is clearly insufficient.",
